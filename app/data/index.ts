...
export const projects = [
  {
    ...
    img: "/code_craft.png",
    iconLists: ["/next.svg", "/tail.svg", "/c.svg", "/convex.svg"],
    link: "https://github.com/ymshreyas/code_craft.git",
  },
  {
    id: 2,
    title: "NeuroFit - AI Fitness Trainer",
    pin_title: "NeuroFit",
    des: "NeuroFit is an AI-driven fitness platform that delivers real-time personalized workouts and diets via a smart voice interface using Next.js, Convex, Clerk, Vapi AI, and Gemini AI.",
    img: "/neuroFit.png",
    iconLists: ["/next.svg", "/gemini.webp", "/Vapi.png", "/convex.svg", "/c.svg"],
    link: "https://github.com/ymshreyas/NeuroFit.git",
  },
  {
    id: 3,
    title: "ConvoX",
    pin_title: "ConvoX",
    des: "ConvoX is a real-time language exchange platform designed to connect users globally through messaging, voice, and video interactions. Features include typing indicators, message reactions, screen sharing, and session recording to enhance engagement and interactivity.",
    img: "/convox.png",
    iconLists: [
      "/mongo.svg",
      "/express.webp",
    ...
    link: "https://github.com/ymshreyas/ConvoX.git",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    img: "/socially.png",
    iconLists: ["/next.svg", "/tail.svg", "/postgres.png", "/c.svg"],
